...
class Generator:
    ...
    def generate_output(self):
        ...
        self.write("import %s as yappsrt\n" % YAPPSRT)
        self.write("\n")
        ...
        if self.postparser is not None:
            ...
            self.write(INDENT, "from sys import argv, stdin, stderr\n")
            ...
            self.write(INDENT, "else: print >>stderr, 'Args:  <rule> [<filename>]'\n")
            self.write("# End -- grammar generated by Yapps\n")
...
class Choice(Node):
    ...
    def output(self, gen, indent):
        ...
        if tokens_unseen:
            gen.write(indent, "else:\n")
            gen.write(indent, INDENT, "raise yappsrt.SyntaxError(self._scanner, _token[0], ")
...
class Star(Wrapper):
    ...
    def output(self, gen, indent):
        ...
        gen.write(indent+INDENT, "raise yappsrt.SyntaxError(self._scanner, charpos=self._scanner.get_prev_char_pos(), context=_context, msg='Need one of ' + ', '.join(%s))\n" %
                  repr(self.first))
