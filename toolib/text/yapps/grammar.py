...
class ParserDescription(yappsrt.Parser):
    ...
    def Tokens(self, _parent=None):
        ...
        while self._peek() in ['"token"', '"ignore"']:
            ...
            if _token == '"token"':
                ...
                raise yappsrt.SyntaxError(self._scanner, _token[0], 'Could not match Tokens')
    ...
    def ClauseC(self, rule, tokens, _parent=None):
        ...
        if _token == 'PLUS':
            ...
            raise yappsrt.SyntaxError(self._scanner, _token[0], 'Could not match ClauseC')
    ...
    def ClauseD(self, rule, tokens, _parent=None):
        ...
        if _token == 'STR':
            ...
            raise yappsrt.SyntaxError(self._scanner, _token[0], 'Could not match ClauseD')
    ...
    def OptParam(self, _parent=None):
        ...
        if _token == 'ATTR':
            ...
            raise yappsrt.SyntaxError(self._scanner, _token[0], 'Could not match OptParam')
