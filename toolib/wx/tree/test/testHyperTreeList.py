...
class Test(object):
	...
	def __init__(self):
		...
		self.tree = HyperTreeList(frame, -1, style=wx.TR_HIDE_ROOT | wx.TR_EDIT_LABELS | wx.TR_DEFAULT_STYLE)

		self.tree.AddColumn('tree')
	...
	def createChild(self, parentItem):
		...
		self.tree.GetMainWindow().CalculatePositions()
